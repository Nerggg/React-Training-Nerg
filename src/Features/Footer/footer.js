...
function Footer() {
  return (
    <div className="sticky absolute bottom-0 inset-x-0 h-[100px] bg-white border-bordergray border-t items-center">
      ...
      <div className="flex relative w-full h-[35px] items-center border-bordergray border-t">
